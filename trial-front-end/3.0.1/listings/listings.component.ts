...
export class ListingsComponent implements OnInit {
  ...
  showProperty(propId: number) {
    this.router.navigateByUrl("/property/"+ propId);
  }
  ...
  ngOnInit(): void {
    ...
    this.propService.getPropertiesByFiltering(this.dataSharing.formData).subscribe((data: Property[]) => { this.propService.properties = data; console.log(this.propService.properties[0].id); });
